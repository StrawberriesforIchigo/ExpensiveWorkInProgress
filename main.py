...
Answer \'T\' if you make decisions logically or \'F\' if you make decisions sentimentally.
  ...
  print('''
Question4
Okay final question here! Do you feel more comfortable abiding to the rules, 
sticking to plans, and tend to be more organized or do you prefer to have your 
options open, act spontaneously, and be flexible with your plans?
Answer \'J\' if you are the rule abider or \'P\' if you like to be flexible with 
your options.
       ''')
  q4 = input().upper()
  if q4 == 'J':
